...
import { deleteSavedCropRecommendation } from '../../services/cropService';

interface SavedCropDetailScreenProps {
  route: {
    params: {
      crop: Crop;
    };
...
const SavedCropDetailScreen = ({ route, navigation }: SavedCropDetailScreenProps) => {
...
export default SavedCropDetailScreen;
